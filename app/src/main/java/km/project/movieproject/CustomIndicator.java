...
public class CustomIndicator implements ViewPager.OnPageChangeListener {
    ...
    private int defaultSizeInDp = 20;
    private int defaultSpacingInDp = 20;

    public CustomIndicator(@NonNull Context context, @NonNull LinearLayout containerView, @NonNull ViewPager viewPager, @DrawableRes int drawableRes) {
        if (context == null) {
